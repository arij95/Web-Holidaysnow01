...
class VoyageOrganiseController extends Controller
{
    ...
    public function rechercheAjaxAction(Request $request)
    {
        $voyage= new Voyageorganise();
        $em=$this->getDoctrine()->getManager() ;
       // $voyageorganise=$em->getrepository('VoyageOrganiseBundle:Voyageorganise')->findAll();
       ...
       // $voyage= new Voyageorganise();
            ...
            if ($request->isXmlHttpRequest()) {
                ...
                $voyageorganise = $em->getRepository('VoyageOrganiseBundle:Voyageorganise')
                    ->findByp($request->get('voyageorganise'));
                $data = $serializer->normalize($voyageorganise);
                dump($data) ;
        ...
        //$voyage = $this->getDoctrine()->getRepository('VoyageOrganiseBundle:Voyageorganise');
        return $this->render('@VoyageOrganise/VoyageOrganise/rechercheAjax.html.twig', array(
            'voyageorganise' => $voyage,
