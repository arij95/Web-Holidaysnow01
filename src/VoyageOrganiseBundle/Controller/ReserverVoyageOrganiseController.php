...
class ReserverVoyageOrganiseController extends Controller
{
    ...
    public function affResAction()
    {
        ...
        $res= $this->getDoctrine()->getRepository('VoyageOrganiseBundle:Reservervoyageorganise')->supress($id);
    ...
    public function afficherVoyageorguserrAction(){
        $voyage= $this->getDoctrine()->getRepository(Voyageorganise::class)->findAll();
        return $this->render("@VoyageOrganise/VoyageOrganise/afficheHebergementuserr.html.twig",array('voyageorganise'=>$voyage));
