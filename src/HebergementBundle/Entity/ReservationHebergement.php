...
class ReservationHebergement
{
     ...
     * @var string
     *
     * @ORM\Column(name="tauxchambre", type="string", nullable=false)
     */
    private $tauxchambre;
     ...
     * @return string
     */
    public function getTauxchambre()
    {
        return $this->tauxchambre;
    }

    /**
     * @param string $tauxchambre
     */
    public function setTauxchambre($tauxchambre)
    {
